...
public class PackController {
	...
	public AjaxResult packStart(
		...
		AjaxResult r = this.packService.packStart(jrPk, equipmentId, workerId, memberIds, user, spjangcd);
	...
	public AjaxResult packStartNoJob(
		...
		AjaxResult r = this.packService.packStartNoJob(
				productMatId, orderQty, pkLots, equipmentId, workerId, memberIds, prodDate, user, spjangcd);
		if (!r.success) rollback();
		return r;
	}
